...
9.  Что из перечисленного НЕ является преимуществом использования Агрегатов?
    *   **A)** Упрощение управления транзакциями.
    *   **B)** Обеспечение целостности данных.
    *   **C)** Увеличение производительности запросов к базе данных.
    *   **D)** Упрощение моделирования сложных доменных концепций.

10. Какой подход к проектированию Агрегатов является наиболее подходящим?
    *   **A)** Создавать как можно больше мелких Агрегатов для максимальной гибкости.
    *   **B)** Создавать как можно меньше крупных Агрегатов для упрощения архитектуры.
    *   **C)** Определять границы Агрегатов на основе бизнес-правил и инвариантов.
    *   **D)** Создавать Агрегаты на основе структуры базы данных.
