...
from ..shared_kernel import DomainEvent, EntityId  # Добавлен DomainEvent
from .domain import CheckInRecord, CheckInStatus, Guest, Room, RoomStatus
...
class IMaintenanceService(Protocol):
    ...
    def schedule_maintenance(
        self, room_id: EntityId, start_time: datetime, end_time: datetime, reason: str
    ) -> None:
