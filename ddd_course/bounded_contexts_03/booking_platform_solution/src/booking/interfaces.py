...
from .domain import Booking, Room, Guest, BookingStatus
...
class IRoomRepository(Protocol):
    ...
    def find_available_rooms(
        ...
        check_in: Optional[DateRange] = None,
        check_out: Optional[DateRange] = None
    ) -> List[Room]:
...
class IBookingNotifier(Protocol):
    ...
    @abstractmethod
    def send_booking_cancellation(self, booking: Booking, reason: Optional[str] = None) -> None:
