...
class TestBookingAccountingIntegration:
    ...
    async def test_booking_cancellation_creates_refund(self, booking_service, accounting_service):
        """
    ...
    async def test_early_checkout_creates_adjustment(self, booking_service, accounting_service):
        """
        ...
        adjustment_items = [
            item for item in updated_invoice.items 
