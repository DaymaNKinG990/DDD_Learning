...
Подробная документация по мониторингу и CI/CD: [README_MONITORING.md](README_MONITORING.md)
...
# Запуск с мониторингом (Prometheus, Grafana, Alertmanager)
docker-compose -f docker-compose.microservices.yml up -d
...
- **Метрики**: HTTP запросы, бизнес-метрики, системные ресурсы

### CI/CD Pipeline
- **GitHub Actions** - автоматические тесты и сборка
- **Docker** - контейнеризация всех сервисов
- **Безопасность** - сканирование уязвимостей (Bandit, Safety)
- **Миграции БД** - автоматические миграции при старте сервисов

### Переменные окружения
- Файл `env.example` содержит все настройки
...
7. **Мониторинг** - Prometheus, Grafana, алерты ✅
8. **CI/CD** - GitHub Actions, автоматические тесты ✅
9. **Миграции БД** - автоматические миграции при старте ✅
